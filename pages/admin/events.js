...
export default function AdminEventsPage({ session }) {
  ...
  if (authState !== 'ok') return <AdminLayout session={session} title="Events"><div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><p style={{ color: '#4a5e42', fontFamily: '"JetBrains Mono", monospace', fontSize: 11 }}>LOADING…</p></div></AdminLayout>

  return (
    <AdminLayout session={session} title="Manage Events">
